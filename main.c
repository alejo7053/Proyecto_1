...
int main(void)
{
	...
	init_pair(1, COLOR_WHITE, COLOR_BLACK);	/* Pair 1 -> Texto blanco fondo Negro */	
	init_pair(2,COLOR_RED, COLOR_BLACK); /*Pair 2 -> Texto rojo fondo Negro*/
	init_pair(3,COLOR_GREEN, COLOR_BLACK);/*Pair 3 -> texto verde fondo negro*/
	...
	for(i=0; i<5; i++)
	{
		border( ACS_VLINE, ACS_VLINE, 
				...
				ACS_LLCORNER, ACS_LRCORNER	); /*Dibuja un borde en la ventana de comandos*/
